  ...
  return (
    <div className="blobYellow flex items-center justify-center">
      <Card
        color=""
        shadow={false}
        className="w-[300px] h-[200px] flex bg-blue-gray-200  items-center justify-center px-5 max-w-[26rem] drop-shadow-2xl shadow-black"
      >
        <CardHeader
          color="transparent"
          floated={false}
        ...
        >
          <Typography className="text-white text-[13px]">
            ...
            use !!!&quotfound solution to all my design needs ;
          </Typography>
        </CardHeader>
